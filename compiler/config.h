...
#define	PEEPFLOW		/* Include peephole flow optimisations       */
...
#define	TOPSPEED		/* Enable Topspeed compiler extensions       */
 ...
 */
#define	VERBOSE			/* Support verbose mode */
#define	ICODE			/* Support icode analysis code */
/*
