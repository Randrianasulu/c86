 ...
 *
 *	15 Mar 99	DJW v5.16 - Forced use of GWASS when target is 68020 or higher.
 *
 *	13 Apr 99	DJW v5.17 - Fixed problem if 68020 or higher specified and -fpu used.
 *							Would double up parameters for calling GWASS!
 *							(problem reported by George Gwilt)
 *
 *	08 Aug 00	DJW v5.18 - Added "-lang" option for C99 compliant C68
 *
 *	26 May 01	DJW v5.19 - Fixes to allow "." as file separtor to work correctly
 */

#define VERSION " v5.19 "
#define COPYRIGHT "(c)1991-2001  D.J.Walker"
